...
Meridian計画ではコア開発メンバーの皆さんを集めて毎月～隔月ごとに定例会を設けています。これらは基本的にDiscordで運用されています。

ユーザでMeridianの開発に興味のある方は、現在の[開発状況の管理ページ](https://github.com/orgs/meridian-oss/projects/1)より確認できます。
...
既存のプログラムに対して改良や修正案のある方は、Discordでご連絡ください。
